peakfasta = "xxxxxx/promotersonly.fa"
rtable = "xxxxxx/R_PromotersFiltered.txt"
#TO DO: ADD IF FREQ2 IN OPPDICT KEYS CLAUSE TO ALL LENGTH KMERS
import csv
gene2enhancer = {}
enhancer2gene = {}
gene_fc = {}
...
ed.enhancer_diversity(5, gene_seq, gene_fc, False, 'C')
ed.enhancer_diversity(6, gene_seq, gene_fc, False, 'C')
ed.enhancer_diversity(7, gene_seq, gene_fc, False,'A')
ed.enhancer_diversity(8, gene_seq, gene_fc, False,'G')
#enhancer_diversity(9, False, False, 10, 'A')
#enhancer_diversity(10, False, False)
