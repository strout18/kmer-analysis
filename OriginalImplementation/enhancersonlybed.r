fasta = read.table("/Users/stella/Downloads/enhanceristhisright.bed")
colnames(fasta) = c("chr", "start", "stop")
fasta = fasta[,1:3]
fasta$all = paste(fasta$chr, fasta$start, fasta$stop, sep = " ")
max10 = read.table("/Users/stella/Desktop/Lin Lab/R_FinalFiltered.txt")
...
write.table(ultimate, file = "/Users/stella/Desktop/Lin Lab/R_EnhancersFiltered.txt", quote = FALSE, sep = "\t", row.names = FALSE)
