fpkm = read.table("/xxxxx/Genes.fpkm_table.txt")
...
library(readxl)
e2g = read_xlsx("/xxxxxx/HAEC_P65_TNF_4hr_1_peaks_AllEnhancers_ENHANCER_TO_GENE.xlsx")
...
write.table(max10final, file = "/xxxxxx/R_FinalFiltered.txt", quote = FALSE, sep = "\t", row.names = FALSE)
